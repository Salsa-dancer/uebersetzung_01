@echo on
@:: "C:\DATEN\GitHub\uebersetzung_01\Vorbereite_uebersetzung_fuer_repo_24.bat"
@::
@:: 
@:: 
@::=============================================================================
...
@SET QuellBasis=C:\SVN_Workdir\PYTHA.24

::@SET ZielVerzeichnis="Ausgabe"
@SET ZielVerzeichnis=".\24"
...
@SET Quellwurzel=%QuellBasis%\Zentrale
